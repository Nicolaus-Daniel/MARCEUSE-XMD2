...
cmd({
  ...
  try {
    ...
    // Check update status
    let updateMessage = `✅ Your MARCEUSE-XMD❤️2 bot is up-to-date!`;
    if (localVersion !== latestVersion) {
      updateMessage = `🚀 Your MARCEUSE-XMD ❤️2 bot is outdated!
    ...
    await conn.sendMessage(from, {
      ...
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          ...
          newsletterName: 'MARCEUSE-XMD❤️2',
          serverMessageId: 143
        }
      }
    }, { quoted: mek });
