...
async (conn, mek, m, { from, sender, isGroup, reply, participants }) => {
    try {
        ...
        const fakeContact = {
            ...
            message: {
                contactMessage: {
                    displayName: "MARCEUSE-XMD❤️-2 SYSTEM",
                    vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:NEXUS SYSTEM\nORG:MARCEUSE-XMD❤️-2;\nTEL;type=CELL;type=VOICE;waid=255652398614:+255758575032\nEND:VCARD`
                }
            }
        };
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: "MARCEUSE-XMD❤️-2-BOTS 🤟✌",
                    serverMessageId: 300
                }
            }
        }, { quoted: fakeContact });
