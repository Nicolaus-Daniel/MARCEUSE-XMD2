...
const sessdata = config.SESSION_ID.replace("MARCEUSE-XMD-2❤️~", '');
...
const port = process.env.PORT || 9090;
  ...
  console.log('MARCEUSE-XMD-2❤️ CONNECTED SUCCESSFULLY ✅')
...
if (!isReact && config.CUSTOM_REACT === 'true') {
  ...
  async function getAIResponse(message) {
    ...
    } catch { return "MARCEUSE-XMD-2❤️ is online! 🚀"; }
  }
  // ===============================================
  
  app.get("/", (req, res) => { res.send("MARCEUSE-XMD-2❤️ STARTED ✅"); });
